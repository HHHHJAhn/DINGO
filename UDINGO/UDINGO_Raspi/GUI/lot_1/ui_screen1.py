...
################################################################################
## Form generated from reading UI file 'screen1XcRxAH.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QRect(500, 80, 431, 111))
        font = QFont()
...
"")
        ...
        self.frame.setGeometry(QRect(100, 240, 561, 471))
...
"    border-radius: 16px;")
        ...
        self.pushButton.setGeometry(QRect(310, 20, 211, 201))
        self.pushButton.setStyleSheet(u"border-radius: 8px;")
        icon = QIcon()
        icon.addFile(u":/parkinglot/electric-car.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton.setIcon(icon)
        self.pushButton.setIconSize(QSize(200, 200))
        self.pushButton_2 = QPushButton(self.frame)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(50, 20, 211, 201))
        self.pushButton_2.setAutoFillBackground(False)
        self.pushButton_2.setStyleSheet(u"")
        icon1 = QIcon()
        icon1.addFile(u":/parkinglot/chair.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_2.setIcon(icon1)
        self.pushButton_2.setIconSize(QSize(200, 200))
        self.pushButton_2.setAutoExclusive(False)
        self.pushButton_4 = QPushButton(self.frame)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setGeometry(QRect(310, 250, 211, 201))
        self.pushButton_4.setStyleSheet(u"")
        icon2 = QIcon()
        icon2.addFile(u":/parkinglot/small-car (4).png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_4.setIcon(icon2)
        self.pushButton_4.setIconSize(QSize(200, 200))
        self.pushButton_3 = QPushButton(self.frame)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(50, 250, 211, 201))
        self.pushButton_3.setStyleSheet(u"")
        icon3 = QIcon()
        icon3.addFile(u":/parkinglot/car (2).png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_3.setIcon(icon3)
        self.pushButton_3.setIconSize(QSize(200, 200))
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(750, 240, 521, 461))
